...
function init(e) {
  ...
  if (typeof W === 'undefined' || typeof W.loginManager === 'undefined' || typeof W.prefs === 'undefined' || typeof W.map === 'undefined') {
    setTimeout(init, 300);
    return;
  }
  ...
  function displayAlignPage(overlay, key) {
    ...
    var numZoomLevels = W.map.getLayers()[0].numZoomLevels;
    instructions.textContent = '';
